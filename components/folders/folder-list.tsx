...
export function FolderList({
          ...
          <div className="hidden group-hover:flex items-center gap-1">
            ...
            {onDeleteFolder && !folder.is_default && (
              <button
                ...
                className="p-1 rounded hover:bg-red-100 dark:hover:bg-red-900/30 text-neutral-500 hover:text-red-600"
                title="Delete folder"
              >
                🗑️
              </button>
  ...
  return (
    <div className="space-y-1">
      ...
      <Button
        variant="ghost"
        className="w-full justify-start gap-2 mt-2 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white"
