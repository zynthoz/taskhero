...
export default function LeftSidebar({ user, loading = false }: LeftSidebarProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-neutral-50 dark:bg-[#0a0a0a] overflow-y-auto">
      ...
      {/* Logout */}
      <div className="p-2 md:p-3 pb-[calc(3rem+env(safe-area-inset-bottom))] md:pb-[calc(0.75rem+env(safe-area-inset-bottom))] border-t border-neutral-200 dark:border-neutral-800 shrink-0">
        <button
