...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-6 shadow-sm transition-colors hover:border-neutral-300 dark:hover:border-neutral-700',
      className
    )}
    {...props}
  />
